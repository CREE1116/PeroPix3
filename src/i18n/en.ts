...
export const en = {
  ...
  drop: {
    ...
    apply: "Import",
    applyHint: "Brings only the checked items into the current tab",
    ...
    toGalleryHint: "Puts this image straight into the gallery (nothing is generated)",
  ...
  settings: {
    ...
    streamPreviewHint: "Streams NAI's in-progress frames into the waiting cell. It does not change the result.",
