...
export const ko: Dict = {
  ...
  options: {
    ...
    seed: "Seed",
    seedHint: "랜덤이어도 고칠 수 있습니다. 이 값으로 뽑은 뒤 새 시드로 바뀝니다",
    seedRoll: "새 시드 뽑기",
    seedRandom: "랜덤",
    misc: "옵션",
  ...
  censor: {
    ...
    runAll: "전체 검열",
    runAllHint: "담아 둔 그림을 전부 찾아 검열 중 탭으로 넘어갑니다.",
    complete: "검열 완료",
    completeHint: "찾은 것이 없는 그림도 결과 폴더에 함께 담깁니다.",
    cancel: "취소",
    resave: "다시 저장",
    resaveHint: "더한 박스만큼 가려 새 파일을 하나 더 만듭니다.",
  ...
  scenes: {
    ...
    pip: "PIP 미리보기",
    pipTitle: "미리보기",
    pipHint: "칸에 마우스를 올리면 여기에 크게 뜹니다",
  ...
  gallery: {
    ...
    unkept: "갤러리에서 뺐습니다",
    renamed: "이름을 바꿨습니다",
    renameHint: "이름을 더블클릭하면 고칠 수 있습니다",
    newFolder: "새 폴더",
