...
export const ko: Dict = {
  ...
  drop: {
    ...
    pickSeed: "시드",
    toGallery: "갤러리에 추가",
    toGalleryHint: "이 그림을 그대로 보관함에 넣습니다 (생성하지 않습니다)",
    added: "갤러리에 넣었습니다",
  ...
  settings: {
    ...
    streamPreviewHint: "NAI 가 그리는 도중의 그림을 흘려 받아 대기 칸에 보여 줍니다. 결과는 달라지지 않습니다.",
