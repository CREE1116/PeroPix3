...
export const ko: Dict = {
  ...
  block: {
    ...
    newBlock: "새 블록",
    addExtra: "+ 추가",
    extraHint: "이 탭에서만 붙습니다. 포즈세트 카드로 저장할 때 빠지고, 색과 이름은 못 바꿉니다.",
  ...
  focus: {
    ...
    help: "큰 그림을 그냥 인페인트하면 NAI 가 그림 전체를 줄여서 다시 그립니다. 결과가 원본보다 작아지고 고치지 않은 곳까지 바뀝니다. 켜면 칠한 자리 둘레만 잘라 보내고 원본 해상도가 그대로 유지됩니다. 잘라낸 조각이 작을수록 크게 그려져 더 촘촘해집니다.",
    onDesc: "사각형 안만 잘라 보냅니다. 모서리를 끌면 크기가, 띠를 끌면 위치가 바뀝니다.",
    offDesc: "끄면 그림 전체가 줄어들어 나갑니다.",
    notNeeded: "이 그림은 통째로 보내도 줄어들지 않습니다.",
  ...
  options: {
    ...
    seedRound: "랜덤",
    seedScene: "완전 랜덤",
    seedFixedHint: "숫자칸 그대로 씁니다. 같은 그림을 다시 만듭니다",
    seedRoundHint: "한 바퀴에 시드 하나를 씁니다. 그 바퀴의 씬들이 같은 조건이라 서로 견줄 수 있습니다",
