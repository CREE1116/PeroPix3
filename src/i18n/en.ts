...
export const en = {
  ...
  block: {
    ...
    newBlock: "New block",
    addExtra: "+ Extra",
    extraHint: "Applies to this tab only — left out when saved as a pose-set card. Its color and name are fixed.",
  ...
  imgIn: {
    ...
    sizeFitted: "Resolution matched to the image — {w}×{h} (you can still change it)",
    plus: "Inpaint+",
  ...
  settings: {
    ...
    tabGeneral: "General",
    token: "NAI token",
    tokenSet: "Saved — paste a new one to replace",
    ...
    modelFixed: "Vertex has no model list API — showing verified ones.",
    loading: "Loading…",
    refresh: "Refresh",
    llmModel: "Model",
  ...
  tools: {
    ...
    keepHint: "Carries the metadata over — you can regenerate later.",
  ...
  censor: {
    ...
    targets: "Look for",
    conf: "Threshold",
    confHint: "Lower finds more — and more false ones.",
    method: "How to cover",
    m_mosaic: "Mosaic",
    m_blur: "Blur",
    m_black: "Black",
  ...
  act: {
    ...
    settingsHint: "Prompt, size, sampler — everything from this image",
  ...
  cell: {
    ...
    notGenerated: "Nothing in this cell yet — Generate this cell",
    back: "← {name} (Esc)",
    keyHint: "← → take · ↑ ↓ cell · S star · Enter keep only · Del hide",
    keepOnly: "Keep only this",
    keepOnlyHint: "Enter — hide the other {n} in this cell (not deleted)",
    hidden: "{n} hidden",
