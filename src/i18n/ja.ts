...
export const ja: Dict = {
  ...
  options: {
    ...
    seed: "Seed",
    seedHint: "ランダムでも編集できます。この値で生成した後、新しいシードに変わります",
    seedRoll: "新しいシードを引く",
    seedRandom: "ランダム",
    misc: "オプション",
  ...
  settings: {
    ...
    about: "アプリ情報",
    support: "バグ報告 / 要望",
    supportHint: "ブラウザーで Discord が開きます。",
    notifySound: "音でも通知",
    notifyVolume: "音量",
    notifyTest: "試聴",
    title: "設定",
  ...
  censor: {
    ...
    runAll: "一括検出",
    runAllHint: "追加した画像をすべて検出して検閲中タブに進みます。",
    complete: "一括保存",
    completeHint: "何も見つからなかった画像も結果フォルダに入ります。",
    cancel: "キャンセル",
    resave: "再保存",
    resaveHint: "追加したボックスを隠してもう一つファイルを作ります。",
  ...
  gallery: {
    ...
    unkept: "ギャラリーから外しました",
    renamed: "名前を変えました",
    renameHint: "名前をダブルクリックすると変えられます",
    newFolder: "新しいフォルダ",
