...
export const ja: Dict = {
  ...
  block: {
    ...
    newBlock: "新しいブロック",
    addExtra: "+ 追加",
    extraHint: "このタブだけに付きます — ポーズセットカードには含まれません。色と名前は変えられません。",
  ...
  imgIn: {
    ...
    cacheEmpty: "まだありません。",
    cacheUse: "このエンコードを使う",
    sizeFitted: "解像度を画像に合わせました — {w}×{h}（変更できます）",
    plus: "インペイント+",
  ...
  options: {
    ...
    seedRoundHint: "一巡ごとに1シード — その巡のシーンが同条件になる",
  ...
  tools: {
    ...
    exifDrop: "画像をここにドロップ — 外部の画像も読めます",
    exifPrompts: "プロンプト",
    exifSettings: "設定",
    ...
    keepHint: "メタデータをそのまま引き継ぎます — あとで再生成できます。",
    renameOn: "名前も変更",
    prefix: "接頭辞",
    start: "開始番号",
    pad: "桁数",
  ...
  scenes: {
    lockCard: "カードごとロック — このカードのシーンは生成から外れます",
    fold: "たたむ",
    unfold: "開いて編集",
  ...
  cell: {
    ...
    notGenerated: "このセルはまだ未生成 — このセルだけ生成",
    back: "← {name} (Esc)",
    keyHint: "← → テイク · ↑ ↓ セル · S 星 · Enter これだけ · Del 非表示",
    keepOnly: "これだけ残す",
    keepOnlyHint: "Enter — このセルの他 {n} 枚を隠す（削除しない）",
    hidden: "非表示 {n}",
    unhideAll: "再表示",
  ...
  gallery: {
    ...
    keepHint: "設定ごとコピーします",
    kept: "保管しました",
    pureNai: "NAI 原本です — UC プリセット・品質タグは復元できません。",
    folders: "フォルダ",
    all: "すべて",
    countImages: "{n}枚",
