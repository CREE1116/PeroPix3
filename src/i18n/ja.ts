...
export const ja: Dict = {
  ...
  focus: {
    ...
    help: "大きな画像を普通にインペイントすると、NAI は絵全体を縮めて描き直します。結果が元より小さくなり、直していない場所まで変わります。オンにすると塗った場所の周りだけを切り出して送り、元の解像度がそのまま保たれます。切り出した断片が小さいほど大きく描かれ、より緻密になります。",
    onDesc: "四角の中だけを送ります。角をドラッグで大きさ、帯をドラッグで位置が変わります。",
    offDesc: "オフにすると絵全体が縮んで送られます。",
    notNeeded: "この絵は丸ごと送っても縮みません。",
